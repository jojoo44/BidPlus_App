...
class _ContractorRFPDetailsScreenState
  ...
  Future<void> _checkIfSubmitted() async {
    try {
      ...
      final data = await supabase.from('proposals')
          .select('id').eq('RFP', widget.rfpId).eq('submitterUserId', userId);
  ...
  Future<void> _notifyManager(String contractorName) async {
    try {
      ...
      // جيب الـ proposalID اللي تم إدراجه
      final proposals = await supabase.from('proposals')
          .select('ProposalID')
          .eq('RFP', widget.rfpId)
          .eq('submitterUserId', supabase.auth.currentUser!.id)
          .order('ProposalID', ascending: false)
          .limit(1);
      final proposalId = proposals.isNotEmpty
          ? proposals.first['ProposalID']?.toString() : null;
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setSheetState) => Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min,
            ...
            const Text('Submit Proposal', style: TextStyle(color: Colors.white,
            ...
            const SizedBox(height: 8),
            TextField(
              controller: descController, maxLines: 4,
              style: const TextStyle(color: Colors.white),
              decoration: InputDecoration(
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: isSubmitting
                    ...
                    : const Text('Submit Proposal', style: TextStyle(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _isLoading
          ...
          : _rfp == null
              ? const Center(child: Text('RFP not found',
              ...
              : SingleChildScrollView(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text(_rfp!['title'] ?? 'Untitled', style: const TextStyle(
                        ...
                        Container(
                          ...
                          child: const Text('Open for Proposals', style: TextStyle(
                    ...
                    _hasSubmitted
                        ? Container(
                            ...
                            child: const Row(mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                ...
                                SizedBox(width: 8),
                                Text('Proposal Already Submitted', style: TextStyle(
                        ...
                        : SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              child: const Text('Submit Proposal', style: TextStyle(
