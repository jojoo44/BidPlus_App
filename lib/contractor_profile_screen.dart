  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          _isOwner ? 'My Profile' : '$_username\'s Profile',
              ...
              children: [
                isImage
                    ...
                    : Column(
                        ...
                        children: [
                          Icon(
                            isLink ? Icons.link : Icons.picture_as_pdf,
                            color: isLink ? blue : Colors.red,
                            size: 26,
                          ),
